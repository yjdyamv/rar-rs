...
fn rar5_solid_reader_recovers_after_writer_failure() {
    assert_solid_reader_recovers_after_writer_failure(ArchiveVersion::Rar50, "solid-rar5.rar");
}

#[test]
fn rar4_solid_reader_recovers_after_writer_failure() {
    assert_solid_reader_recovers_after_writer_failure(ArchiveVersion::Rar40, "solid-rar4.rar");
}
