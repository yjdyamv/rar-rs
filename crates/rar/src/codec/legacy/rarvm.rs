...
//! is decoded and executed here, matching the reference decoder.

use crate::error::RarError;

/// Interpreter-local error, converted to [`RarError`] at the `rar29`
/// boundary; kept separate so the unit tests can compare variants.
