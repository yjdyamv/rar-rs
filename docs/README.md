...
| [`PLAN.md`](../PLAN.md) | 工程计划：现状、待办、已完成里程碑、加固记录、一致拒绝、已知差异、改代码前必读 | 计划工作量 / 对齐进度 / 改代码前 / 查历次加固 |
...
| [`adr/0005-rar4-edit-architecture.md`](adr/0005-rar4-edit-architecture.md) | RAR4 编辑架构决策记录（对齐官方、solid 整档 repack、分卷/-hp 边界、分阶段） | 修改 RAR4 编辑 / 理解决策约束 |
