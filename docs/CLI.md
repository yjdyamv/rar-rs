...
> Last verified: 2026-09-22 @ `bef8842`; switch coverage is checked against the
...
| `r`         |       | Repair the archive with its recovery record; with no record, reconstruct `rebuilt.<name>` from the members that still decode, like WinRAR                                                                    |
