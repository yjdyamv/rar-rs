...
> Last verified: 2026-09-22 @ `6b6669e`; switch coverage is checked against the
...
| `rr`        |       | Add an inline recovery record. A bare `-rr<N>` is the legacy RAR4 parity-sector count (`-rr10` writes exactly ten sectors at any archive size, like WinRAR); `-rr<N>%` is a percentage of the protected prefix; bare `-rr` is WinRAR's 3% default. RAR5 records are sized by percent only, so a bare `-rr<N>` means that percent there. Mutually exclusive with `-rv`                                                                                                                                                                                                                                                                                                                                                |
