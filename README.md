...
> Last verified: 2026-09-22 @ `1bffd0f`; implementation details are
...
- **Recovery** — inline recovery records and `.rev` recovery volumes (RAR5 REV5
  ...
  still decode and verify, resyncing past corrupt headers (RAR5, unencrypted
  headers) and exiting 3 when a header was lost, like WinRAR.
